...
class resetpasspatient extends StatefulWidget {
  const resetpasspatient({Key? key}) : super(key: key);

  @override
  State<resetpasspatient> createState() => _resetpasspatientState();
}

class _resetpasspatientState extends State<resetpasspatient> {
  String msgStatus = '';
