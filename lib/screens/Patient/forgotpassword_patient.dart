...
class forgotpassword_patient extends StatefulWidget {
  const forgotpassword_patient({Key? key}) : super(key: key);

  @override
  State<forgotpassword_patient> createState() => _forgotpassword_patientState();
}

class _forgotpassword_patientState extends State<forgotpassword_patient> {
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  if (_formKey.currentState!.validate()) {
                                    Get.to(() =>
                                        forgotpasswordverification_patient());
                                  }
                                },
                              ),
                            ),
