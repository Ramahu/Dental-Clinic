...
class forgotpasswordverification_doctor extends StatefulWidget {
  const forgotpasswordverification_doctor({Key? key}) : super(key: key);

  @override
  State<forgotpasswordverification_doctor> createState() =>
      _forgotpasswordverification_doctorState();
}

class _forgotpasswordverification_doctorState
    extends State<forgotpasswordverification_doctor> {
